export default function AtomLogo({ className = "", ...props }) {
    return (
        <svg
            viewBox="0 0 36 36"
        ...
        >
            ...
            <rect x="0" y="0" width="36" height="36" fill="none" opacity="0" />
        </svg>
    );
}
